...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Users/sardor/Development/MY_RESUME/source_codes/php/Angular-PHP-CRUD/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = '/Users/sardor/Development/MY_RESUME/source_codes/php/Angular-PHP-CRUD/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
        }
